...
<header>
    ...
    <div class="add">
        <button > <a href="sindex.php">Add User</a></button>
    </div>
   ...
   $id=$row["ID"];
    ...
    echo '    <tr>
      ...
      <td>
          ...
          <div class="up">
      <button > <a href="supdate.php?updateid='.$id.'">Update</a></button>
      </div>

       <div class="del">
      <button onclick="confirmDelete()"><a href="sdelete.php?deleteid='.$id.'">Delete</a></button>
            </div>
...
function confirmDelete() {
    if (confirm('Are you sure you want to delete this item?')) {
        ...
        window.location.href = 'sdelete.php?deleteid=' + id;
    }
