...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE travel SET Remainder='$etitle', Date='$edate', Time='$etime', Erepeat='$eremain' WHERE id=$id";
    $result = mysqli_query($con, $sql);

    if ($result) {
        // Display alert and redirect to read.php
        echo "<script>alert('tUpdated Successfully!'); window.location.href='tread.php';</script>";
    } else {
