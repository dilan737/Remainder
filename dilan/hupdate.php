...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE hobbies SET Remainder='$etitle', Date='$edate', Time='$etime', Erepeat='$eremain' WHERE id=$id";
    $result = mysqli_query($con, $sql);

    if ($result) {
        // Display alert and redirect to read.php
        echo "<script>alert('Updated Successfully!'); window.location.href='hread.php';</script>";
    } else {
