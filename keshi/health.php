...
<head>
    ...
    <title>Health Reminder - RemindMate</title>
...
<body>
    ...
    <main>
        ...
        <form action="save_health_reminder.php" method="POST">
            <label for="category">Select your Health reminder category:</label>
		...
		<div class="previous-button">
			<a href="health_read.php">
				<button type="submit">Visit Saved Health Reminders</button>
			</a>
		</div>
    </main>
