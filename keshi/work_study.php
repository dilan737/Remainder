...
<head>
    ...
    <title>Work/Study Reminder - RemindMate</title>
...
<body>
    ...
    <main>
        ...
        <form action="save_work_study_reminder.php" method="POST">
		...
		<div class="previous-button">
			<a href="work_study_read.php">
				<button type="submit">Visit Saved Work & Study Reminders</button>
			</a>
		</div>
    </main>
