...
<head>
    ...
    <title>PersonalReminder - RemindMate</title>
...
<body>
    ...
    <main>
        <h1 id="cat-title">Personal</h1>

        <!-- Form with onsubmit validation -->
        <form action="save_personal_reminder.php" method="POST">
		...
		<div class="previous-button">
			<a href="personal_read.php">
				<button type="submit">Visit Saved Personal Reminders</button>
			</a>
		</div>
    </main>
