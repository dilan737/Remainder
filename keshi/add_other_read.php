...
$sql="SELECT title,date,time,description FROM addother";
...
if($result->num_rows>0)
{
	...
	{
		echo"<tr>";
		echo "<td>".$row["title"]."</td>"."<td>".$row["date"]."</td>"."<td>".$row["time"]."</td>"."<td>".$row["description"]."</td>";
		echo"</tr>";
	}
...
<body>
	...
	<!-- Form with onsubmit validation -->
        <form action="add_other_update.php" method="POST">
...
<body>
	...
	<!-- Form with onsubmit validation -->
        <form action="add_other_delete.php" method="POST">
			<h3><label for="title">Reminder Title:</label></h3>
