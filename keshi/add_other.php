...
<head>
    ...
    <title>Add Other Reminder - RemindMate</title>
...
<body>
    ...
    <main>
        ...
        <form action="save_add_other_reminder.php" method="POST">
            <!--<label for="category">Select your Work/Study reminder category:</label>
		...
		<div class="previous-button">
			<a href="add_other_read.php">
				<button type="submit">Visit Saved Other Reminders</button>
			</a>
		</div>
    </main>
