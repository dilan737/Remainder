...
$sql="SELECT type,title,date,time,description FROM health";
...
<body>
	...
	<!-- Form with onsubmit validation -->
        <form action="health_update.php" method="POST">
            <h3><label for="category">Select your Health reminder category:</label></h3>
            <select id="category" name="category">
                <option value="medication">Medication</option>
                <option value="workout">Workout</option>
                <option value="doctor's_appointments">Doctor's appointments</option>
            ...
            <textarea id="descripti name="description" placeholder="Type here..." required></textarea>
